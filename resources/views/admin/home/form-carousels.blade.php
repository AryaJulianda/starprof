            ...
            <div class="row">
              <div class="col-12">
                <div class="mt-3">
                  ...
                  <input type="text" class="form-control" id="text_1" placeholder="Text 1" name="text_1" value="{{ isset($dataForm) ? $dataForm->text_1 : '' }}" {{ $type == 'view' ? 'disabled' : 'required' }}>
                </div>
              </div>
              <div class="col-12">
                <div class="mt-3">
                  <label for="text_2" class="form-label">Text 2</label>
                  <input type="text" class="form-control" id="text_2" placeholder="Text 2" name="text_2" value="{{ isset($dataForm) ? $dataForm->text_2 : '' }}" {{ $type == 'view' ? 'disabled' : 'required' }}>
                </div>
              </div>
              <div class="col-12">
                <div class="mt-3">
