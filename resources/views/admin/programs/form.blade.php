            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="mt-3">
                  ...
                  <input type="file" accept="image/*" class="form-control" id="prog_image_file" placeholder="prog_image_file" name="prog_image_file" value="" onchange="previewImage(event)" {{ $type == 'view' ? 'disabled' : '' }}>
                </div>
              </div>
              <div class="col-12">
                <div class="mt-3">
